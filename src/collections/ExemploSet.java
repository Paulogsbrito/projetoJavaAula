...
public class ExemploSet {
	...
	public static void main(String[] args) {
		...
		// Lista todos os elementos da Collection Set com o Objeto da Classe Iterator (Iterar = Percorrer)
		System.out.println("\n\nListar todos os Elementos com o Iterator");
        
		// Iterator trabalha somente com a tipagem e na sequencia a tiapagem deve ser declarada(isetFrutas)
		Iterator<String> isetFrutas = setFrutas.iterator();
		

		// while = enquanto
		// chama o metodo hasNext para verificar se tem um proximo item
		// E enquanto houver um item ele será exibido
